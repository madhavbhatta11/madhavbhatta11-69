import { Instagram, Facebook, Youtube, Twitter, Linkedin, Github, MessageCircle } from 'lucide-react';
...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    { icon: MessageCircle, href: 'https://wa.me/9779868869289', label: 'WhatsApp' }
